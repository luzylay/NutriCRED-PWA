...
def evaluate_measurement(measurement_type: str, value: float, age_months: int, sex: str):
    """
    ...
    return ("normal", "Medición registrada correctamente.", "Default Validation", "System Config")
