        ...
        <div className="flex justify-between items-start relative z-10">
          <div>
            ...
            <p className="text-white/80 mt-2 text-sm max-w-[260px] leading-relaxed">
              Esquema oficial de vacunación. Recuerda que todas son gratuitas en
      ...
      <div className="px-5 -mt-8 relative z-20 space-y-6">
        <div className="bg-amber-50/50 dark:bg-amber-900/10 rounded-[2rem] p-5 shadow-lg border border-amber-200 dark:border-amber-900/30 flex gap-4 items-center">
          ...
          <div>
            ...
            <p className="text-xs text-amber-700/80 dark:text-amber-400/80 mt-1">
              Faltan 14 días para el control de 2 meses. Ubica tu posta más
              cercana a tiempo.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 border-t border-border pt-6 pb-4 text-center">
          ...
          <p className="text-xs text-muted-foreground max-w-md mx-auto leading-relaxed">
            ...
            Información de dominio público. <br />
            <br />
            <em>Descargo de responsabilidad:</em> Las fechas son referenciales.
            Consulte siempre en su Centro de Salud o con su médico tratante ante
            cualquier duda sobre el estado vacunal de su menor.
          </p>
        </div>
      </div>
    </div>
