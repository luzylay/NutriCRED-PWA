      ...
      <div className="bg-card w-full max-w-md rounded-[2rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
              ...
              <div className="space-y-2.5 max-h-[45vh] overflow-y-auto pr-2 custom-scrollbar pb-14">
                {ALARM_SIGNS.map((sign, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`size-7 rounded-lg border-2 shrink-0 flex items-center justify-center transition-all ${
        ...
        <div className="p-5 border-t border-border bg-muted/10 flex justify-between gap-3">
          ...
          <button
            ...
            className="px-6 py-3 rounded-xl font-black text-sm text-white shadow-lg flex items-center gap-2 transition-all hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed bg-gradient-to-r from-rose-500 to-red-600 shadow-rose-500/20 cursor-pointer"
          >
            Reportar Emergencia
          </button>
        </div>
