...
export const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  es: {
    ...
    "settings.theme_light": "Yanapiri Clásico",
    "settings.theme_dark": "Oscuro Cuida-Vista",
  ...
  qu: {
    ...
    "settings.theme_light": "Yanapiri K'anchay",
    "settings.theme_dark": "Laqha Ñawi Waqaychaq",
    "settings.theme_andean": "Qucha Q'omer Andino",
    "settings.theme_sunset": "Inti Raymi Q'oñi",
  ...
  ay: {
    ...
    "settings.theme_light": "Yanapiri Qhana",
    "settings.theme_dark": "Ch'iyara Nayra Jark'iri",
    "settings.theme_andean": "Ch'uxña Andino",
    "settings.theme_sunset": "Willka Jalanta",
